...
- [cyianor/rastr](https://github.com/cyianor/rastr): Software rasterizer written in Rust
- [cyianor/ithmbrdr](https://github.com/cyianor/ithmbrdr): Extract photos from Apple's *.ithmb format (used on old iPods)
